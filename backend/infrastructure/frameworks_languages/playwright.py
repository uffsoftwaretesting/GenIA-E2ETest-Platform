"""Playwright execution strategies."""
...
from .runtime import build_js_runtime, discover_node_executable, strip_code_fences, strip_common_imports, strip_typescript_annotations, extract_first_callback_body


class _BasePlaywrightExecutionStrategy(BaseExecutionStrategy):
    ...
    def normalize_script(self, script: str, language: str | None = None) -> str:
        ...
        return build_js_runtime(cleaned, mode="playwright", browser_headless=True)


class PlaywrightJavaScriptExecutionStrategy(_BasePlaywrightExecutionStrategy):
...
class PlaywrightTypeScriptExecutionStrategy(_BasePlaywrightExecutionStrategy):
